...
class LocalApplianceTests(unittest.TestCase):
    ...
    def test_appliance_run_auto_compiles_local_vault_before_daily_scout(self) -> None:
        ...
        self.assertEqual(pattern_radar_payload["pattern_scout"]["recommended_next"]["candidate_id"], "pattern-freshness-intake")
        ...
        self.assertTrue(any(item["kind"] in {"approval_gate", "follow_up_question", "task", "local_task"} for item in inbox["priority_items"]))
        ...
        self.assertIn("pattern freshness intake", pattern_radar_html)
