...
9. `daily-research` runs the local loop end to end: plan, collect, memory, scout, refresh plan,
   refresh apply packet, live gate packet, scenario, verdict, ops dashboard, rollup, and product
   brief.
