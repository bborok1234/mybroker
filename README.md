...
3. MyBroker product surfaces: beginner-facing MiroFish-inspired market brief and local analyst screens generated by `mybroker brief`, `mybroker appliance today`, `mybroker appliance agenda`, `mybroker appliance source-refresh`, `mybroker appliance readiness`, `mybroker appliance scheduler summary`, `mybroker appliance journal`, `mybroker appliance tasks`, `mybroker appliance task-ledger`, `mybroker appliance review`, `mybroker appliance review-prompt`, `mybroker appliance review-effect`, and `mybroker appliance pattern-radar`.
