...
Generated by `mybroker brief`, `mybroker appliance today`, `mybroker appliance agenda`, `mybroker appliance source-refresh`, `mybroker appliance readiness`, `mybroker appliance scheduler summary`, `mybroker appliance journal`, `mybroker appliance tasks`, `mybroker appliance task-ledger`, `mybroker appliance review`, `mybroker appliance review-prompt`, `mybroker appliance review-effect`, `mybroker appliance review-response-apply`, and `mybroker appliance pattern-radar`, these are the beginner-facing user surfaces. They show market/narrative maps, key themes, three scenario paths, persona viewpoints, beginner explanations, next inspection questions, daily reading order, source fan-out, source refresh judgment, freshness/readiness status, scheduler operations status, role-specific analyst notes, queued analyst work, task status history, local review memory, copy-ready feedback prompts, review-effect proof, copied-feedback handoff proof, workflow-pattern adoption decisions, and research-only action candidates.
